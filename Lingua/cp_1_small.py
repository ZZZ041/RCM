...
'''
仅压缩首个数据，压缩模型为small，保存文件为retrieved_file_lingua2small_xxx
retrieved_file_
'''
...
RETRIEVAL_FILE = "/home/zhangzhenzhi/Project/in-context/"
OUTPUT_FILE = "rf_lingua2_one_small0.33"
    ...
    for i in range(0, len(data), BATCH_SIZE):
        ...
        for entry in tqdm(batch, desc=f"Processing batch {i // BATCH_SIZE + 1}"):
            ...
            if not retrieved_docs:
                ...
                compressed_prompt = llm_lingua.compress_prompt(first_doc_text, rate=0.6, force_tokens=['\n', '?'])
